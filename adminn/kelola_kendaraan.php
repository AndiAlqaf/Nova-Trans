...
<body>
    ...
    <div class="main">
        ...
        <div class="control-panel">
            ...
            <button class="btn" id="btnTambahKendaraan"><i class="fas fa-plus"></i> Tambah Kendaraan</button>
    ...
    <div id="modalTambahKendaraan" class="modal">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <span class="close" data-modal="modalTambahKendaraan">×</span>
            </div>
    ...
    <div id="modalEditKendaraan" class="modal">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <span class="close" data-modal="modalEditKendaraan">×</span>
            </div>
    ...
    <div id="modalDetailKendaraan" class="modal">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <span class="close" data-modal="modalDetailKendaraan">×</span>
            </div>
            <div class="detail-container">
                <div class="detail-row"><div class="detail-label">ID</div><div class="detail-value" id="detail_id"></div></div>
                <div class="detail-row"><div class="detail-label">Nomor Polisi</div><div class="detail-value" id="detail_nopol"></div></div>
    ...
    <div id="modalDeleteKendaraan" class="modal">
        <div class="modal-content" style="max-width: 450px;">
            <div class="modal-header">
                <h2><i class="fas fa-exclamation-triangle" style="color: #dc3545;"></i> Konfirmasi Hapus</h2>
                <span class="close" data-modal="modalDeleteKendaraan">×</span>
            </div>
    ...
    <script>
        ...
        function showDetailModal(id) {
            ...
            document.getElementById('detail_last').textContent = r.dataset['last-maintenance'];
            document.getElementById('detail_next').textContent = r.dataset['next-maintenance'];
        ...
        function showNotification(msg, type = 'success') {
            ...
            n.innerHTML = `<span>${msg}</span><button>×</button>`;
